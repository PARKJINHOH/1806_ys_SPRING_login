/**
 * Mcx Dialog Mobile v0.1.0 Copyright (C) 2018 mcx
				...
				(function() {
					...
					var layer = {
						initOpen : function initOpen(dom, options) {
							...
							if (!options.bottom) {
								// set position
								dom.style.top = (document.documentElement.clientHeight - dom.offsetHeight)
										/ 2 + "px";
								dom.style.left = (document.documentElement.clientWidth - dom.offsetWidth)
										/ 2 + "px";
							}
						},
					...
					var mcxDialog = {
						...
						toast : function toast(content, time) {
							...
							toast.style.left = (document.documentElement.clientWidth - toast.offsetWidth)
									/ 2 + "px";
						...
						loading : function loading(options) {
							...
							loading.style.left = (document.documentElement.clientWidth - loading.offsetWidth)
									/ 2 + "px";
							loading.style.top = (document.documentElement.clientHeight - loading.offsetHeight)
									/ 2 + "px";
